...
public class NetlistConversionFunctions {
    ...
    public static List<DGate> GatetoNORNOT(DGate g) {
        ...
        if (g.gtype == DGateType.NOT) {
            ...
            outp1.name = "0GatetoNORNOTWire" + wirecount++;
            not1.output = outp1;
            ...
            outp2.name = "0GatetoNORNOTWire" + wirecount++;
            not2.output = outp2;
            ...
            outp3.name = "0GatetoNORNOTWire" + wirecount++;
            nor1.output = outp3;
            ...
            outp4.name = "0GatetoNORNOTWire" + wirecount++;
            nor2.output = outp4;
    ...
    public static List<DGate> GatetoNOR(DGate g) {
        ...
        if (g.gtype == DGateType.NOT) {
            ...
            nor1.input.add(g.input.get(0));
            DWire outp1 = new DWire();
            outp1.name = "0GatetoNORWire" + wirecount++;
            nor1.output = outp1;
            ...
            nor2.input.add(g.input.get(1));
            DWire outp2 = new DWire();
            outp2.name = "0GatetoNORWire" + wirecount++;
            nor2.output = outp2;
            ...
            nor3.input.add(outp2);
            DWire outp3 = new DWire();
            outp3.name = "0GatetoNORWire" + wirecount++;
            nor3.output = outp3;
            ...
            DWire outp4 = new DWire();
            outp4.name = "0GatetoNORWire" + wirecount++;
            nor4.output = outp4;
    ...
    **********************************************************************
    ...
    public static List<DGate> ConvertToFanin2(DGate g) {
        ...
        if (g.input.size() < 3) {
            ...
            for (DGate xgate : reduceTofanin2(g, g.gtype)) {
                fanin2.add(xgate);
            }
    ...
    public static List<DGate> reduceTofanin2(DGate inpgate, DGateType gtype) {
        ...
        while (remainingwires.size() > 2) {
            ...
            for (int i = 0; i < newinpwires.size() - 1; i += 2) {
                ...
                String outWname = "0reduceTofanin2Wire" + wirecount++;
